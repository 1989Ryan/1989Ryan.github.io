...
<p align="center">Project Design</p>
  ...
  We are now focusing on building map with structured semantic information, and try to fusion with real map. I have achieved the semantic SLAM with monocular camera, using ORB_SLAM Mono and PSPNet. And I run the system in KITTI datasets in urban area. The result of the semantic SLAM is shown below, where yellow represent buildings and constructions, red represents roads and sidewalks, blue represents vehicles and green represents vegetation. 

<center><img src="https://github.com/1989Ryan/1989Ryan.github.io/blob/master/map.png?raw=true" /></center>

  The ROS communication structure in my system is shown below. The system is mainly built by myself.

<center><img src="https://github.com/1989Ryan/1989Ryan.github.io/blob/master/graph.png?raw=true" /></center>
